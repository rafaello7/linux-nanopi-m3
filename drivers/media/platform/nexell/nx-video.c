...
static int nx_video_get_selection(struct file *file, void *fh, struct v4l2_selection *a)
{
	u32 pad;
	struct nx_video *me = file->private_data;
	struct v4l2_subdev *subdev = get_remote_subdev(me, a->type, &pad);
...
static struct v4l2_ioctl_ops nx_video_ioctl_ops = {
	...
	.vidioc_g_selection             = nx_video_get_selection,
			       ...
			       const struct media_pad *remote, u32 flags)
{
	...
	}else if( is_media_entity_v4l2_video_device(remote->entity) ) {
